...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('[xfvalue_dataserii] 00:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">С минуты на минуту!</span></span>');
 timer.countDown();
}
...
Следующая серия через: <div id="CDT"></div>
